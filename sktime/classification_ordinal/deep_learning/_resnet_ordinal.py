...
__all__ = ["ResNetOrdinalClassifier"]
...
class ResNetOrdinalClassifier(BaseDeepClassifier):
    """
    ...
    Examples
    --------
    >>> from sktime.classification.deep_learning.resnet import ResNetOrdinalClassifier
    >>> from sktime.datasets import load_unit_test
    >>> X_train, y_train = load_unit_test(split="train")
    >>> clf = ResNetOrdinalClassifier(n_epochs=20, bacth_size=4) # doctest: +SKIP
    ...
    def __init__(
        ...
        super(ResNetOrdinalClassifier, self).__init__()
